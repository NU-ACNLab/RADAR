...
#SBATCH --job-name=RADAR_bidskit ## When you run squeue -u  this is how you can identify the job

# A regular comment in Bash

module load dcm2niix
bidskit -d /projects/b1108/studies/RADAR/data/raw/neuroimaging/bids
