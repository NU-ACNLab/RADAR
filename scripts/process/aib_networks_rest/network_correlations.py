...
path_conn = ('/projects/b1108/studies/TEAM/data/processed/neuroimaging/aib_networks_rest') #or use below for same data
#path_conn = ('/Volumes/ACNL/data_pre_2023/ACarroll/BrainMAPD_T4_rsfMRI/Connectivity')
save_dir1 = ('/projects/b1108/studies/TEAM/data/processed/neuroimaging/aib_networks_rest/final_data')
...
path_output_save1 = save_dir1 + os.path.sep + 'TEAM_nr6_rsfMRIConnectivity_052624.csv'
